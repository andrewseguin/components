...
const EXAMPLE_DATA: ExampleTableItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
...
export class ExampleTableDataSource extends DataSource<ExampleTableItem> {
  data: ExampleTableItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<ExampleTableItem[]> {
   ...
   */
  private _getPagedData(data: ExampleTableItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private _getSortedData(data: ExampleTableItem[]) {
