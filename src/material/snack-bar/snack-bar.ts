...
export class MatSnackBar implements OnDestroy {
  ...
  protected simpleSnackBarComponent: Type<any> = SimpleSnackBar;
  ...
  constructor(
      ...
      @Inject(MAT_SNACK_BAR_DEFAULT_OPTIONS) protected _defaultConfig: MatSnackBarConfig) {}
   ...
   */
  protected _attachSnackBarContainer(overlayRef: OverlayRef,
    ...
    const containerRef: ComponentRef<MatSnackBarContainerInterface> = overlayRef.attach(containerPortal);
