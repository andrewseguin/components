...
export function getMaterialDynamicScheme(
  ...
  useOptimizedColors: boolean,
): DynamicScheme {
  return new DynamicScheme({
    sourceColorArgb: primaryPalette.keyColor.toInt(),
    variant: useOptimizedColors ? 0 : 6, // 0 is Variant.TONAL_SPOT, 6 is Variant.FIDELITY
